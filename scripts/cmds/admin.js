...
module.exports = {
    ...
    onStart: async function ({ message, args, usersData, event, getLang }) {
        ...
        (list) => "⚡〘 ＡＤＭＩＮ ＤＡＳＨＢＯＡＲＤ 〙⚡"  
                + "\n▬▬ι═══════ﺤ═══════ι▬▬"  
                + "\n💾 ＯＷＮＥＲ: ＳＨΛＮ"  
                + `\n🚨 ＡＤＭＩＮ ＵＮＩＴＳ:\n${list}`  
                + "\n▬▬ι═══════ﺤ═══════ι▬▬"  
                + "\n🌐 ＣＯＮＴＡＣＴ: m.me/Sh4n.Dev",
	...
	(list) => "🧸 𝑪𝒖𝒕𝒆𝒔𝒕 𝑪𝒐𝒓𝒆: 𝑶𝒘𝒏𝒆𝒓 & 𝑨𝒅𝒎𝒊𝒏 🧸"
                + "\n 💞══════════════💞"
                + "\n 🐻 𝑶𝒘𝒏𝒆𝒓 𝑻𝒆𝒅𝒅𝒚:"
                + "\n ✨ 𝑆𝐻𝐴𝑁 ✨"
                + "\n 🐾 𝑭𝒖𝒛𝒛𝒚 𝑭𝒓𝒊𝒆𝒏𝒅𝒔 (Admins):"
		+ `\n ${list}`
		+ "\n 🍯 𝑭𝒃: m.me/Sh4n.Dev"
		+ "\n 🎠 |__ꜱʜᴀɴ'ꜱ_ʙᴏᴛ__|",
    ...
    const randomStyle = adminListStyles[Math.floor(Math.random() * adminListStyles.length)];
    return message.reply(randomStyle(getNames.join("\n")));
}
